...
| 插件 | 状态 | 说明 | 文档 |
|---|---|---|---|
| [dsh-prefix-completion](plugins/dsh-prefix-completion/) | 🚧 M1+M2 已实现，待热更验证 | 聊天输入框续写联想（DeepSeek 对话前缀续写 Beta 转发 + dock 建议条） | [README](plugins/dsh-prefix-completion/README.md) · [spec](plugins/dsh-prefix-completion/docs/spec/) |
