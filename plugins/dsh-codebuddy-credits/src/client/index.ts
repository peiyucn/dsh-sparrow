...
const LOCALE_DICTS = {
  zh: {
    ...
    'indicator.account': '企业：{enterprise}',
    'indicator.quotaLine': '额度：{limit}/月',
    'indicator.used': '已用 {used} / 剩余 {remaining}',
    'indicator.reset': '重置：{reset}',
  ...
  en: {
    ...
    'indicator.account': 'Enterprise: {enterprise}',
    'indicator.quotaLine': 'Quota: {limit}/month',
    'indicator.used': 'Used {used} / remaining {remaining}',
