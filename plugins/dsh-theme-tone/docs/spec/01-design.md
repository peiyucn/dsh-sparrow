...
| 持久化设置（客户端读写） | `ctx.configForms.get(entryId)`（entryId = `dsh-theme-tone`），`ctx.inject(['configForms'], …)` 可选 fork | `ui-settings/README.md:32/58`、`ui-settings/src/client/settings-scope.ts:221` | 官方 `ui-chat/src/client/apply.ts:82`、`ui-conversation/src/client/apply.ts:129`、`ui-settings-plugins/src/client/index.ts:68` |
