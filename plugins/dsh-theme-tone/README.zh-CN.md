...
* 细腻的颗粒质感
* **抬升面** —— 菜单、对话框、浮动提示条、抬升卡片 —— 继承该色调的色相
* 交互态（hover / 按下 / 选中）、分隔线与滚动条也跟着染色
...
![设置 → 常规里的色调行](https://raw.githubusercontent.com/peiyucn/dsh-sparrow/main/resources/dsh-theme-tone.png)
