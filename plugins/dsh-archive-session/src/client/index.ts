...
const LOCALE_DICTS = {
  zh: {
    ...
    'dialog.title': '归档会话管理',
    'dialog.close': '关闭',
    'dialog.intro': '备份可逆、删除不可逆；备份后不再出现在 @ 列表。',
    'dialog.backupDir': '备份位置：',
    'dialog.copyHint': '点击复制完整路径',
    'dialog.copied': '已复制',
    'dialog.uninstallHint': '卸载不会恢复备份；卸载前请先在备份区「全部恢复」。',
    'loading': '加载中…',
  ...
  en: {
    ...
    'dialog.close': 'Close',
    'dialog.intro': 'Backup is reversible, delete is not; backed-up sessions leave the @ list.',
    'dialog.backupDir': 'Backups: ',
    'dialog.copyHint': 'Click to copy the full path',
    'dialog.copied': 'Copied',
    'dialog.uninstallHint': 'Uninstalling does not restore backups; restore all before uninstalling.',
    'loading': 'Loading…',
