...
* **触发灵敏度**：胶囊右侧 ▾ 可选**高 / 中 / 低**三档（按钮内竖排三点指示当前档：恒显 3 点、自下而上点亮 3/2/1 个，悬停有提示），续写模型固定 `deepseek-v4-flash`。三档规则：

  | 档位 | 停顿 | 最短草稿 | 夹入英文半词 | 词后空格 | 句末标点 |
  |---|---|---|---|---|---|
  | 高 | 250ms | 中文 4 字 / 英文 2 字符 | 联想 | 联想 | 联想 |
  | 中（默认） | 400ms | 中文 8 字 / 英文 3 字符 | 联想 | 联想 | 不联想 |
...
![触发灵敏度三档选择](docs/images/model-picker.png)
