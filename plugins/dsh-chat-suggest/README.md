...
* **Sensitivity**: the ▾ next to the pill picks **High / Medium / Low** (a vertical row of 3 dots in the pill shows the level — always 3 dots, 3/2/1 lit from the bottom, with a hover hint); the completion model **follows your selected main model** (v4-pro / v4-flash; falls back to pro for vision etc.). The rules:
