...
|---|---|---|---|---|---|
| eager（高） | 250ms | CJK 6 / Latin 4 | 放行 | 放行 | 放行 |
| standard（中，默认） | 400ms | CJK 10 / Latin 6 | 抑制 | 放行 | 抑制 |
| conservative（低） | 800ms | CJK 14 / Latin 10 | 抑制 | 抑制 | 抑制 |
...
* [ ] 三档切换立即影响停顿时长与形态门控（纯函数有单测：eager 6 字触发/半词/句末放行、conservative 空格抑制与 14 字门槛）；
