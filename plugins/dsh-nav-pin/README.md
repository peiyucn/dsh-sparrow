...
* The conversation content width is capped: on wide columns even dragged to the widest it keeps at least 160px clearance per side (official: 88px); on narrow columns the content clamps to the official 640px minimum to make room for the rail, so the right drag handle no longer crowds the turn rail
