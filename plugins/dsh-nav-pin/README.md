...
* The conversation content width is capped: even dragged to the widest, it keeps at least 130px clearance per side (official: 88px), so the right drag handle no longer crowds the turn rail
