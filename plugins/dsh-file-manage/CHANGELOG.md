...
- Renamed package from `@dsh-sparrow/dsh-file-session` to `@dsh-sparrow/dsh-file-manage` (decided 2026-09-01; route / locale namespace / CSS classes and other internal identifiers aligned; the old name was never published, no migration cost)
